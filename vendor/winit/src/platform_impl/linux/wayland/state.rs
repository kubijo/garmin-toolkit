...
use crate::platform_impl::wayland::types::xdg_activation::{ActivationInput, XdgActivationState};
...
pub struct WinitState {
    ...
    /// Latest real input, consumed once by a window focus request.
    pub activation_input: Arc<Mutex<Option<ActivationInput>>>,
