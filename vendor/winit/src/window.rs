...
impl Window {
    ...
    ///
    /// - **iOS / Android / Orbital:** Unsupported.
    /// - **Wayland:** Requires `xdg_activation_v1` and recent pointer, keyboard, or touch input
    ///   on an application window. The input is consumed once; the compositor decides whether
    ///   to grant activation.
    #[inline]
