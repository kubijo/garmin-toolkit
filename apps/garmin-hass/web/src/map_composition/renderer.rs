//! Worker-owned wgpu surface for activity maps and the standalone composition fixture.
...
impl CompositionRenderer {
    ...
    pub async fn create(canvas: web_sys::OffscreenCanvas, mode: &str) -> Result<Self, JsValue> {
        ...
        // This renderer uses only raster rendering. Default WebGPU limits request compute support,
